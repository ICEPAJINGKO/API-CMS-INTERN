...
export class LoginLogService {
    ...
    // log list of pageuser query
    public async pageUserLogList(userId: number, limit: number): Promise<any> {
        return await this.loginLogRepository.pageUserLogList(userId, limit);
    }
}
